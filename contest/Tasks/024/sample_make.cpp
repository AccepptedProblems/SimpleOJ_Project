...
{
    int n = rand(test * test * test * 10);
    int m = rand(test * test * test * test * test * test * 10) + test * test * test * test * test * test * 10;
    fi << n << " " << m << endl;
    for(int i=1; i<=n; i++)
        fi << rand(test * test * test * test * test * test * 10) << " ";
}
